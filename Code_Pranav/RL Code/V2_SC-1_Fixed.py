...
class V2AllegroReachingEnvFixed(VecEnv):
    ...
    def _compute_improved_reward(self, base_pos, target_pos, tendon_forces, binary_tactile,
        ...
        if self.reward_curriculum_phase >= 1:
            distance_reward = np.exp(-20.0 * distance)  # FIXED: Increased from 6.0 to 20.0 for stronger gradient
...
def main():
    ...
    wandb_config = {
        ...
        "reward_components": 5,
        "reward_weights": {
            "distance": "exponential(-20*d)",  # FIXED: Much stronger (was -6*d)
        ...
        "reward_curriculum_phases": {
            ...
            "phase_5_hand_shape": "160K-200K timesteps"  # Fixed
        },
        "target_curriculum_phases": {
            "phase_1_static": "0-160K timesteps",
            "phase_2_slow_moving": "160K-180K timesteps",
            "phase_3_dynamic": "180K-200K timesteps"
        },
    ...
    try:
        ...
        print("  ✓ Distance reward scaling: 6.0 → 20.0 (3.3x stronger)")
        ...
        print("\nFIXED Target Curriculum:")
        print("  Phase 1: Static targets (0-160K timesteps)")
        print("  Phase 2: Slow moving targets (160K-180K timesteps)")
        print("  Phase 3: Dynamic targets (180K-200K timesteps)")
