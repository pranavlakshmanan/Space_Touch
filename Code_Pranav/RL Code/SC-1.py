...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Total Training Timesteps: 500,000")
        ...
        csv_file = data_logger.save_to_csv("sc1_tendon_training_data.csv")
        ...
        final_csv = data_logger.save_to_csv("sc1_tendon_training_data_final.csv")
        ...
        if 'data_logger' in locals():
            csv_file = data_logger.save_to_csv("sc1_tendon_training_data_interrupted.csv")
