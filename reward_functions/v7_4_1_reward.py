#!/usr/bin/env python3
"""
V7.4.1 Hybrid Derivative + Distance Reward Calculator

Key changes from V7.4:
- Stronger distance reward (20.0 scale, 80:20 ratio with derivative)
- More distance guidance compared to V7.4
- Same smoothed overlap (EMA) for stable signal
...
Reward composition:
- 80% Derivative overlap (±100 reward, dominant)
- 20% Distance reward (0-20 reward, more guidance)
"""
...
class V741RewardCalculator:
    """
    V7.4.1 Hybrid reward: Derivative overlap (primary) + Distance (secondary)

    Ratio: 80:20 (derivative:distance)
    """
    ...
    def __init__(self, config: Dict = None):
        ...
        # V7.4.1: Derivative reward parameters (unchanged from V7.3)
        ...
        # V7.4.1: Distance reward parameters (80:20 ratio - STRONGER than V7.4)
        self.distance_reward_scale = config.get('distance_reward_scale', 20.0)  # 2x V7.4
    ...
    def update_phase(self, phase: int):
        """V7.4.1: Phases disabled - no-op for compatibility"""
        pass
    ...
    def reset(self):
        ...
        # V7.4.1: Reset smoothed overlap and previous
        self.overlap_ema = 0.0
        self.previous_overlap = 0.0

    def get_smoothed_overlap(self) -> float:
        """V7.4.1: Get smoothed overlap for observation space"""
        return self.overlap_ema

    def calculate_reward(self, obs: Dict) -> Tuple[float, Dict]:
        """
        V7.4.1 Hybrid reward calculation (80:20 ratio)
        ...
        try:
            ...
            # V7.4.1: Update smoothed overlap (EMA)
            ...
            # ============================================
            # V7.4.1 HYBRID REWARD CALCULATION (80:20)
            # ============================================

            reward = 0.0
            reward_components = {}

            # Component 1: Derivative overlap (PRIMARY - 80%)
            ...
            # Component 2: Distance reward (SECONDARY - 20%, STRONGER than V7.4!)
